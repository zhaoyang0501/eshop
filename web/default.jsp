  ...
  <tr>
	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TR align="center">
		  ...
		  <TD class="header_menu" align="middle">
		  	<A href="reg.jsp"><span class="whiteTitle"><bean:message key="menu.item6"/></span></A>
		  </TD>
		 <TD background="images/Bule_06.gif" width="2"></TD>
          <TD class="header_menu" align="middle">
          ...
          <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD class="C_Item_bg" valign="top">
					<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
					  <TR>
						<TD class="C_Sort_Title">网站公告</TD>
					  </TR>
					  <logic:notPresent name="noticeList">
						  <TR>
							<TD class="redText">没有公告！</TD>
						  </TR>					  
					  </logic:notPresent>
					  <TR height="10"><TD></TD></TR>	
					  <logic:present name="noticeList">
					  	<logic:iterate id="cate" name="noticeList" type="com.ORM.Notice">
						  <TR>
							<TD class="text">
								&nbsp;<img src="images/cateIcon.gif" border="0">
								<a href="mer.do?method=showNotice&id=${cate.id}">${cate.title} </a>
							</TD>
						  </TR>						  		
					  	</logic:iterate>
					  </logic:present>
